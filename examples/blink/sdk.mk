...
SOURCE_FILES += $(SDK_DIR)/libraries/libboard/source/board_memories.c
...
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/exceptions.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/mpu.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/pio.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/pio_it.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/pmc.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/supc.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/timetick.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/xdma_hardware_interface.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/xdmac.c
SOURCE_FILES += $(SDK_DIR)/libraries/libchip/source/xdmad.c
